...
namespace StudentManagementSystem
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("1.Faculty 2.Student");
            ...
            switch (n)
            {
                case 1:
                    ...
                    Console.WriteLine("1.Add Student Details \n 2.Manage Student Details \n 3.Add Course Details \n " +
                                        "4.Manage Course Details \n 5.Add Enrollments Details \n 6.Manage Enrollments Details " +
                                        "\n 7.Add College Details \n 8.Manage College Details \n 9.Add Course Duration Details");
                    ...
                    switch (n1)
                    {
                        ...
                        case 2:
                            Console.WriteLine("Manage Student Details");
                        ...
                        case 4:
                            Console.WriteLine("Manage Course Details");
                            {
                        ...
                        case 6:
                            Console.WriteLine("Manage Enrollments Details");
                        ...
                        case 9:
                            ...
                            CourseDurationBL cbl1 = new CourseDurationBL();
                            /*DataSet ds1 = cbl1.UpdateCourseDataBL(CourseName);
                            ...
                            //bo4.Name = Console.ReadLine();
                            bo4.Duration = Console.ReadLine();
                            CourseDurationBL blc2 = new BusinessLayer.CourseDurationBL();
                            int c1 = blc2.UpdateCourseDuration(bo4);
                            if (c1 != 0)
                                Console.WriteLine("Successfully Update Course Duration");
                            else
                                Console.WriteLine("Failed to Update Course Duration");
                            }
                    break;
                    }
